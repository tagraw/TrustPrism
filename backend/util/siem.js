...
export const SIEM_EVENT_CATEGORY = {
    ...
    // Re-authentication events — TACC §3.05
    REAUTH_REQUIRED_ROLE_CHANGE:        "PRIVILEGED_ACCOUNT_ACTIVITY",
    REAUTH_REQUIRED_CREDENTIAL_CHANGE:  "CONFIDENTIAL_DATA_HANDLING",
    REAUTH_REQUIRED_MFA_CHANGE:         "CONFIDENTIAL_DATA_HANDLING",
    SESSION_INVALIDATED:                "AUTH_AUTHORIZATION",
    STEP_UP_REQUIRED:                   "PRIVILEGED_ACCOUNT_ACTIVITY",
    SESSION_UNLOCKED:                   "AUTH_AUTHORIZATION",
    MFA_SKIPPED_DISABLED:               "AUTH_AUTHORIZATION",
};
